...
::: {.callout-tip}
## Prerequisites
This page assumes basic familiarity with R programming. New to R? Start with [R for Data Science](https://r4ds.had.co.nz/) (chapters 1-8).
:::
...
::: {.callout-tip}
## When R Isn't Fast Enough
For computationally intensive loops that can't be vectorized (e.g., simulation studies with millions of iterations), consider **Rcpp** to write C++ code called from R. See the [Rcpp Integration Guide](../templates/package-development.qmd#rcpp-integration) for setup, examples, and best practices.
:::
...
- [Claude Code Guide](../claude-code/index.qmd) - AI-powered coding assistant
