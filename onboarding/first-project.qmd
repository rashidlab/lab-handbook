...
mkdir -p /proj/rashidlab/my-first-project/data/raw
mkdir -p /proj/rashidlab/my-first-project/data/processed

# Create a symlink from your repo to the data
ln -s /proj/rashidlab/my-first-project/data data

# Your .gitignore already excludes data/
```

Now place any data files in `/proj/rashidlab/my-first-project/data/raw/` and they'll be accessible via `data/raw/` in your code.
