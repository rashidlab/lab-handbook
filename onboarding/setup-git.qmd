...
Setup → [GitHub Fundamentals](github-fundamentals.qmd) → [Git Practices](../coding-standards/git-practices.qmd)
:::
...
[Git Phase 1: Setup]{.meta-item}
:::
::: {.path-nav}
[Next: GitHub Fundamentals →](github-fundamentals.qmd)
:::
:::
