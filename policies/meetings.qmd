...
### Phase 1: Create the Agenda (Wednesday)
...
1. **Title:** `Lab Meeting - YYYY-MM-DD` (use this Friday's date)
   - Example: `Lab Meeting - 2026-02-07`
...
```
📋 Lab meeting agenda is up for Friday [DATE]!

Please add your items by Thursday 5pm:
...
### Phase 2: Monitor Contributions (Thursday)
...
### Phase 3: Facilitate the Meeting (Friday)
...
### Phase 4: Post Meeting Notes (Friday EOD)
...
Reminder: Create the agenda thread by Wednesday 5pm.
