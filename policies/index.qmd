...
For a step-by-step walkthrough of setting up data for a new project, see [Your First Project — Set Up Data Directory](../onboarding/first-project.qmd#set-up-data-directory).
:::
