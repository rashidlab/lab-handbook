...
::: {.breadcrumb-nav}
[Claude Code](../index.qmd) [/]{.separator} [Advanced](index.qmd) [/]{.separator} [Enforcing Standards]{.current}
:::
...
- [Hooks](hooks.qmd) (automation triggers)
:::
:::
