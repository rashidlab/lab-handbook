...
::: {.breadcrumb-nav}
[Claude Code](../index.qmd) [/]{.separator} [Advanced]{.current}
:::

::: {.learning-path-indicator}
::: {.path-meta}
[[Advanced]{.level-badge .level-advanced}]{.meta-item}
[5 min read]{.meta-item}
[Phase 4: Advanced]{.meta-item}
:::
::: {.path-nav}
[← HPC Usage](../hpc-usage.qmd)
[Next: Global Config →](global-config.qmd)
:::
:::
...
:::
::: {.prereq-list}
- [Daily Workflow](../daily-workflow.qmd) (comfortable with basic usage)
:::
:::
