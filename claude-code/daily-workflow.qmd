...
### Writing Tests (TDD) {#writing-tests}
...
**The checkpoint connection:** Commit after tests are written, commit after implementation passes. If you later change the function and tests break, `git diff` shows exactly what you changed (see [Commits as Checkpoints](#commit-checkpoints)).
